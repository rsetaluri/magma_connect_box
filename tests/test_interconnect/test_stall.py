...
def test_stall(dw_files, io_sides):
    ...
    configs_mem = [("strg_ub_app_ctrl_input_port_0", 0, 0),
                   ...
                   ("strg_ub_input_addr_ctrl_address_gen_0_ranges_0", (512 - 1) * 1, 0),
                   ("strg_ub_input_addr_ctrl_address_gen_0_ranges_1", (512 - 1) * 512, 0),
                   ...
                   ("strg_ub_output_addr_ctrl_address_gen_0_ranges_0", (512 - 1) * 1, 0),
                   ("strg_ub_output_addr_ctrl_address_gen_0_ranges_1", (512 - 1) * 512, 0),
