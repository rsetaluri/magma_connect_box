...
def construct():
  ...
  custom_synth_scripts = Step( this_dir + '/custom-dc-scripts'                  )
  ...
  if synth_power:
    post_synth_power     = Step( this_dir + '/tile-post-synth-power'     )
  ...
  synth.extend_inputs( custom_synth_scripts.all_outputs() )
  ...
  synth.extend_outputs(['design.spef', 'design.sdf'])
...
#  synth.set_param( 'order', order )
  ...
  g.add_step( custom_synth_scripts     )
  g.add_step( iflow                    )
  ...
  g.connect_by_name( custom_synth_scripts, synth )
  g.connect_by_name( constraints, iflow          )
  g.connect_by_name( custom_synth_scripts, iflow    )
